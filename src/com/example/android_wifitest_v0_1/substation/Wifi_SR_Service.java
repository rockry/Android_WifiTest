...
public class Wifi_SR_Service extends Service {
    private String tag = "Wifi_SR_Service";
    
    private int Loop_cnt = SuspendResumeActivity.Loop_cnt;
    ...
    public void onCreate() {
        Log.i(tag, SuspendResumeActivity.Loop_cnt + "WifiStart.");
        super.onCreate();
        
        powerManager = (PowerManager) getSystemService(Context.POWER_SERVICE);
        mWifiManager = (WifiManager) this.getSystemService(WIFI_SERVICE);
        Loop_cnt = SuspendResumeActivity.Loop_cnt;
                ...
                public void run() {
                    ...
                    while (isRunning && i <= Loop_cnt) {
                        ...
                        if (Onresult && Offresult) {
                            Intent intent = new Intent(SuspendResumeActivity.WIFI_SR_SUCCESS);
                            sendBroadcast(intent);
                            Log.d(tag, "Send Success Broadcast");
                        } else {
                            Intent intent = new Intent(SuspendResumeActivity.WIFI_SR_FAIL);
                            sendBroadcast(intent);
                    ...
                    Intent intent = new Intent(SuspendResumeActivity.WIFI_SR_FINISH);
                    sendBroadcast(intent);
                }
            });
            Loop_thread.start();
    ...
    public void onDestroy() {
        Log.d(tag, "WiFi_SR_service onDestroy");
