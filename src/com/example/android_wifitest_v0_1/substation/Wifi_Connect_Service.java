...
public class Wifi_Connect_Service extends Service {
    private String tag = "Wifi_Connect_Service";
    private int Loop_cnt = ConnectActivity.Loop_cnt;
    ...
    public void onCreate() {
        Log.i(tag, ConnectActivity.Loop_cnt + "WifiStart.");
        super.onCreate();
	...
	public Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            Loop_thread = new Thread(new Runnable() {
                public void run() {
                    Loop_cnt = ConnectActivity.Loop_cnt;
...
//                            }
                        ...
                        if (ConnectResult && DisconnectResult) {
                            Intent intent = new Intent(ConnectActivity.WIFI_CONNECT_SUCCESS);
                            sendBroadcast(intent);
                        } else {
                            Intent intent = new Intent(ConnectActivity.WIFI_CONNECT_FAIL);
                            sendBroadcast(intent);
                        }
                        i++;
                    }
                    
                    Intent intent = new Intent(ConnectActivity.WIFI_CONNECT_FINISH);
                    sendBroadcast(intent);
                }
            });
            Loop_thread.start();
    ...
    class DefaultBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (WifiManager.SUPPLICANT_STATE_CHANGED_ACTION.equals(action)) {
                ...
                WifiInfo wi = Wifi_Connect_Service.mWifiManager.getConnectionInfo();
