...
public class HiddenApConnectActivity extends Activity implements OnClickListener{
    private String Tag = "HiddenApConnectActivity";
    ...
    public static String connect_ssid = "Wi-Fi_Hidden_AP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.station_hidden);
        ConnectButton = (ToggleButton)findViewById(R.id.sHiddenButton);
        ssid = (EditText)findViewById(R.id.sHiddenSSID);
        passwd = (EditText)findViewById(R.id.sHiddenPASS);
        loop = (EditText)findViewById(R.id.sHiddenLoop);
        success = (TextView)findViewById(R.id.sHiddenSuccess);
        fail = (TextView)findViewById(R.id.sHiddenFail);
    ...
    public void onResume(){
        super.onResume();
        Log.d(Tag, "[HiddenApConnectActivity]OnResume");
        connect_ssid = "Wi-Fi_Hidden_AP";
    ...
    public void onPause() {
        super.onPause();
        Log.d(Tag, "[HiddenApConnectActivity]OnPause");
        unregisterReceiver(mDefaultReceiver);
    }
    @Override
    public void onDestroy(){
        super.onDestroy();
        Log.d(Tag, "[HiddenApConnectActivity]onDestroy");
        WifiServiceStop();
    }
	@Override
    ...
    private void WifiServiceStart() {
        Log.d(Tag, "WifiServiceStart!!");
        
        getLoop_cnt();
        Intent intent = new Intent(HiddenApConnectActivity.this, Wifi_HiddenAp_Service.class);
        
        WifiServiceName = startService(intent);
        Toast toast = Toast.makeText(getApplicationContext(),
                "Wifi_HiddenAp_Service Start!", Toast.LENGTH_SHORT);
        toast.show();
        isTestRunning = true;
    }
...
//      networkID = 0;
        ...
        Toast toast = Toast.makeText(getApplicationContext(),
                "Wifi_HiddenAp_Service destroy!", Toast.LENGTH_LONG);
        toast.show();   
        isTestRunning = false;
    }
